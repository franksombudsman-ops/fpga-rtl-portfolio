...
proc create_root_design { parentCell } {
  ...
  set actuator_pwm_out [ create_bd_port -dir O actuator_pwm_out ]
...
\
  ...
  # Create instance: soc_sensor_control_bd_0, and set properties
  set block_name soc_sensor_control_bd
  set block_cell_name soc_sensor_control_bd_0
  if { [catch {set soc_sensor_control_bd_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $soc_sensor_control_bd_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins soc_sensor_control_bd_0/S_AXI]
  ...
  connect_bd_net -net ad1_sdata_a_1 [get_bd_ports ad1_sdata_a] [get_bd_pins soc_sensor_control_bd_0/ad1_sdata_a]
  connect_bd_net -net ad1_sdata_b_1 [get_bd_ports ad1_sdata_b] [get_bd_pins soc_sensor_control_bd_0/ad1_sdata_b]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins soc_sensor_control_bd_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN]
  connect_bd_net -net soc_sensor_control_bd_0_actuator_pwm_out [get_bd_pins soc_sensor_control_bd_0/actuator_pwm_out] [get_bd_ports actuator_pwm_out]
  connect_bd_net -net soc_sensor_control_bd_0_ad1_cs_n [get_bd_pins soc_sensor_control_bd_0/ad1_cs_n] [get_bd_ports ad1_cs_n]
  connect_bd_net -net soc_sensor_control_bd_0_ad1_sclk [get_bd_pins soc_sensor_control_bd_0/ad1_sclk] [get_bd_ports ad1_sclk]
  connect_bd_net -net soc_sensor_control_bd_0_irq_out [get_bd_pins soc_sensor_control_bd_0/irq_out] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins soc_sensor_control_bd_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK]
  ...
  assign_bd_address -offset 0xA4000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs soc_sensor_control_bd_0/S_AXI/reg0] -force
