 ...
 *
 * End-to-end Pmod AD1 hardware validation:
 * Pmod AD1 -> SPI acquisition -> AXI4-Stream packetizer
 * -> asynchronous AXI4-Stream FIFO
 * -> AXI DMA S2MM -> DDR -> Cortex-A53
 *
 * Verifies eight consecutive real ADC packets.
 */
...
#define PACKET_HEADER       0xAD100001U
...
int main(void)
{
    ...
    xil_printf("\r\n");
    xil_printf("============================================\r\n");
    xil_printf("Project 05 - Pmod AD1 DMA Hardware Test\r\n");
    xil_printf("============================================\r\n");
    ...
    for (Packet = 0U; Packet < PACKET_COUNT; ++Packet) {
        ...
        SampleWord = RxBuffer[1];
        SampleA = (SampleWord >> 12) & 0x00000FFFU;
        SampleB = SampleWord & 0x00000FFFU;
        Sequence = RxBuffer[2];
        ...
        xil_printf(
            "PKT[%u] H=%08x A=%03x B=%03x SEQ=%08x T=%08x\r\n",
            (unsigned int)Packet,
        ...
        if ((SampleWord & 0xFF000000U) != 0U) {
            xil_printf(
                "FAIL: packet %u invalid ADC packing\r\n",
                (unsigned int)Packet
            );
            return XST_FAILURE;
        }
    ...
    xil_printf("\r\n");
    xil_printf("8 PACKET AD1 DMA TEST: PASS\r\n");
    xil_printf("Packets verified : %u\r\n",
               (unsigned int)PACKET_COUNT);

    xil_printf("Sequence continuity: PASS\r\n");
    xil_printf("ADC sample packing: PASS\r\n");
    xil_printf("Header/trailer integrity: PASS\r\n");

    xil_printf("\r\n");
    xil_printf(
        "AD1 -> AXIS -> CDC -> DMA -> DDR -> A53: PASS\r\n"
    );
