...
# module references:
# pmod_ad1_acquisition_engine, ad1_axis_packetizer, axis_packet_arbiter_2to1, mpu6050_i2c_master, mpu6050_axis_packetizer
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ad1_cs_n [ create_bd_port -dir O ad1_cs_n ]
...
\
  ...
  # Create instance: pmod_ad1_acquisition_0, and set properties
  set block_name pmod_ad1_acquisition_engine
  set block_cell_name pmod_ad1_acquisition_0
  if { [catch {set pmod_ad1_acquisition_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pmod_ad1_acquisition_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.CLK_FREQ_HZ {25000000} $pmod_ad1_acquisition_0


  # Create instance: xlconstant_ad1_enable, and set properties
  set xlconstant_ad1_enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_ad1_enable ]
  set_property -dict [list \
    CONFIG.CONST_VAL {1} \
    CONFIG.CONST_WIDTH {1} \
  ] $xlconstant_ad1_enable


  # Create instance: ila_ad1_0, and set properties
  set ila_ad1_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_ad1_0 ]
  set_property -dict [list \
  ...
  # Create instance: ad1_axis_packetizer_0, and set properties
  set block_name ad1_axis_packetizer
  set block_cell_name ad1_axis_packetizer_0
  if { [catch {set ad1_axis_packetizer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ad1_axis_packetizer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: axis_packet_arbiter_2to1_0, and set properties
  set block_name axis_packet_arbiter_2to1
  set block_cell_name axis_packet_arbiter_2to1_0
  if { [catch {set axis_packet_arbiter_2to1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_packet_arbiter_2to1_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: mpu6050_axis_packetizer_0, and set properties
  set block_name mpu6050_axis_packetizer
  set block_cell_name mpu6050_axis_packetizer_0
  if { [catch {set mpu6050_axis_packetizer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mpu6050_axis_packetizer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net mpu6050_axis_packetizer_0_m_axis [get_bd_intf_pins mpu6050_axis_packetizer_0/m_axis] [get_bd_intf_pins axis_packet_arbiter_2to1_0/s1_axis]
  ...
  connect_bd_net -net mpu6050_axis_packetizer_0_frame_drop_count [get_bd_pins mpu6050_axis_packetizer_0/frame_drop_count] [get_bd_pins ila_mpu6050_0/probe13]
  connect_bd_net -net mpu6050_axis_packetizer_0_overflow_sticky [get_bd_pins mpu6050_axis_packetizer_0/overflow_sticky] [get_bd_pins ila_mpu6050_0/probe14]
  ...
  connect_bd_net -net mpu6050_i2c_master_0_motion_frame [get_bd_pins mpu6050_i2c_master_0/motion_frame] [get_bd_pins ila_mpu6050_0/probe11] [get_bd_pins mpu6050_axis_packetizer_0/motion_frame]
  connect_bd_net -net mpu6050_i2c_master_0_motion_valid [get_bd_pins mpu6050_i2c_master_0/motion_valid] [get_bd_pins ila_mpu6050_0/probe12] [get_bd_pins mpu6050_axis_packetizer_0/motion_valid]
  ...
  connect_bd_net -net pmod_ad1_acquisition_0_sample_a [get_bd_pins pmod_ad1_acquisition_0/sample_a] [get_bd_pins ila_ad1_0/probe0] [get_bd_pins ad1_axis_packetizer_0/sample_a]
  connect_bd_net -net pmod_ad1_acquisition_0_sample_b [get_bd_pins pmod_ad1_acquisition_0/sample_b] [get_bd_pins ila_ad1_0/probe1] [get_bd_pins ad1_axis_packetizer_0/sample_b]
  connect_bd_net -net pmod_ad1_acquisition_0_sample_tick [get_bd_pins pmod_ad1_acquisition_0/sample_tick] [get_bd_pins ila_ad1_0/probe3]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ad1_axis_packetizer_0/aresetn] [get_bd_pins axis_packet_arbiter_2to1_0/aresetn] [get_bd_pins mpu6050_i2c_master_0/aresetn] [get_bd_pins mpu6050_axis_packetizer_0/aresetn]
